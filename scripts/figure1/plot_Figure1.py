...
ax1.plot(np.arange(2011-100,2011),RFvolc_tmp[-100:],color=color_list['Volcano'],label='Volcano RF of Rm$_{64}$ simulation',linewidth=5)
ax1.plot(np.arange(2011-100,2011),RFvolc[-100:],color='grey',linestyle='--',linewidth=3,label='Volcano RF of control simulation')
...
ax1.plot([the_year,the_year],[-3.2,-1.45],linestyle=':',color='k')
ax1.set_ylim(-2.7,0.5)
ax1.text(1965,-1.7,'year 1964',fontsize='x-large')
...
ax2.plot([0],[0],color=color_list['GHG other'],linewidth=5,label='The response of GMST')
plot_mean=np.mean(data[:,0,the_year-1700:],0)
plot_std=np.std(data[:,0,the_year-1700:],0)
ax2.plot(np.arange(the_year,2011),plot_mean,color=color_list['GHG other'],linewidth=5)
ax2.plot(np.arange(the_year,2011),plot_mean-plot_std,color=color_list['GHG other'],linewidth=2,linestyle='--')
ax2.plot(np.arange(the_year,2011),plot_mean+plot_std,color=color_list['GHG other'],linewidth=2,linestyle='--')
...
#ax3.plot(np.arange(2010-100,the_year),np.mean(data[:,1,1910-1700:the_year-1700],0),color=color_list['FF-CO2'],linewidth=1.5,label='The response of atmospheric\nCO$_2$concentration')
ax3.plot([0],[0],color=color_list['FF-CO2'],linewidth=5,label='The response of atmospheric\nCO$_2$concentration')
ax3.plot(np.arange(the_year,2011),np.mean(data[:,1,the_year-1700:],0),color=color_list['FF-CO2'],linewidth=5)
...
ax3.plot(np.arange(the_year,2011),plot_mean-plot_std,color=color_list['FF-CO2'],linewidth=2,linestyle='--')
ax3.plot(np.arange(the_year,2011),plot_mean+plot_std,color=color_list['FF-CO2'],linewidth=2,linestyle='--')
ax3.legend(loc='upper left',fontsize='x-large')
ax3.set_ylabel('Atmospheric CO$_2$\nconcentration response\n(ppm)',fontsize='x-large')
...
#ax4.plot(np.arange(2010-100,the_year),np.mean(data[:,2,1910-1700:the_year-1700],0),color=color_list['LUC albedo'],linewidth=5,label='The response of RH')
#ax4.plot(np.arange(2010-100,the_year),np.mean(data[:,3,1910-1700:the_year-1700],0),color=color_list['O3t'],linewidth=5,label='The response of NPP')
#ax4.plot(np.arange(2010-100,the_year),np.mean(data[:,4,1910-1700:the_year-1700],0),color='k',linewidth=5,label='The response of net land sink')
ax4.plot([0],[0],color=color_list['LUC albedo'],linewidth=5,label='The response of RH')
ax4.plot([0],[0],color='#0000FF',linewidth=5,label='The response of NPP')
ax4.plot([0],[0],color='k',linewidth=5,label='The response of net land sink')


plot_mean=np.mean(data[:,3,the_year-1700:],0)
plot_std=np.std(data[:,3,the_year-1700:],0)
ax4.plot(np.arange(the_year,2011),plot_mean,color='#0000FF',linewidth=5)
ax4.plot(np.arange(the_year,2011),plot_mean-plot_std,color='#0000FF',linewidth=2,linestyle='--')
ax4.plot(np.arange(the_year,2011),plot_mean+plot_std,color='#0000FF',linewidth=2,linestyle='--')

plot_mean=np.mean(data[:,4,the_year-1700:],0)
plot_std=np.std(data[:,4,the_year-1700:],0)
ax4.plot(np.arange(the_year,2011),plot_mean,color='k',linewidth=5)
ax4.plot(np.arange(the_year,2011),plot_mean-plot_std,color='k',linewidth=2,linestyle='--')
...
ax4.plot(np.arange(the_year,2011),plot_mean,color=color_list['LUC albedo'],linewidth=5)
ax4.plot(np.arange(the_year,2011),plot_mean-plot_std,color=color_list['LUC albedo'],linewidth=2,linestyle='--')
ax4.plot(np.arange(the_year,2011),plot_mean+plot_std,color=color_list['LUC albedo'],linewidth=2,linestyle='--')
...
ax5.plot([0],[0],color=color_list['LUC albedo'],linewidth=5,label='The response of $F_{out}$')
ax5.plot([0],[0],color='#0000FF',linewidth=5,label='The response of $F_{in}$')
ax5.plot([0],[0],color='k',linewidth=5,label='The response of net ocean sink')

plot_mean=np.mean(data[:,7,the_year-1700:],0)
plot_std=np.std(data[:,7,the_year-1700:],0)
ax5.plot(np.arange(the_year,2011),plot_mean,color='k',linewidth=5)
ax5.plot(np.arange(the_year,2011),plot_mean-plot_std,color='k',linewidth=2,linestyle='--')
ax5.plot(np.arange(the_year,2011),plot_mean+plot_std,color='k',linewidth=2,linestyle='--')

plot_mean=np.mean(data[:,5,the_year-1700:],0)
plot_std=np.std(data[:,5,the_year-1700:],0)
ax5.plot(np.arange(the_year,2011),plot_mean,color='#0000FF',linewidth=5)
ax5.plot(np.arange(the_year,2011),plot_mean-plot_std,color='#0000FF',linewidth=2,linestyle='--')
ax5.plot(np.arange(the_year,2011),plot_mean+plot_std,color='#0000FF',linewidth=2,linestyle='--')

plot_mean=np.mean(data[:,6,the_year-1700:],0)
plot_std=np.std(data[:,6,the_year-1700:],0)
ax5.plot(np.arange(the_year,2011),plot_mean,color=color_list['LUC albedo'],linewidth=5)
ax5.plot(np.arange(the_year,2011),plot_mean-plot_std,color=color_list['LUC albedo'],linewidth=2,linestyle='--')
ax5.plot(np.arange(the_year,2011),plot_mean+plot_std,color=color_list['LUC albedo'],linewidth=2,linestyle='--')
...
plt.savefig('D:/NCLIM-19122723/main_figure/Figure1.pdf',dpi=600)
